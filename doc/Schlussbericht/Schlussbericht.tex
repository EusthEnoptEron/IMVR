...
\definecolor{lightgreen}{rgb}{0.6,0.86,0.58}
\definecolor{darkgreen}{rgb}{0.06,0.1,0.05}

\definecolor{lightyellow}{rgb}{0.86,0.86,0.58}
\definecolor{darkyellow}{rgb}{0.1, 0.1,0.05}

\definecolor{lightred}{rgb}{0.86, 0.6,0.58}
\definecolor{darkred}{rgb}{0.1, 0.06,0.05}
...
\usepackage{tabularx}
\usepackage{ae}
\usepackage{pifont}																% better resolution of Type1-Fonts 
\usepackage{nameref}
%\usepackage{floatrow}
\usepackage{wrapfig}
...
\pagenumbering{roman}
\renewcommand{\arraystretch}{1.5} % Increase table spacing
...
\include{kapitel/implementation_indexer}
\include{kapitel/implementation_imvr}
\include{kapitel/tests}
\include{kapitel/projektmanagement}
\include{kapitel/schlussbetrachtung}
...
%\label{chap:pflichtenheft}
%
%\includepdf{../Pflichtenheft/Pflichtenheft}
