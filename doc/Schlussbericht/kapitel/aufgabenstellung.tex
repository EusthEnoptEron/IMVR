...
Wie bereits erwähnt, mangelt es momentan in der Medienwelt nicht an Begeisterung für Virtual Reality. In Foren wird darüber diskutiert, an Events wird es demonstriert und täglich finden neue Infos ihren Weg in die Öffentlichkeit.
...
Sie ist zu einem Preis von \EUR{89.99} erhältlich und ermöglicht eine rein visuelle Handerkennung ohne Handschuhe oder ähnlichen Zusatz.
