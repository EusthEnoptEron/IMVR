...
\afterpage {
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{ l X }
			...
			IMDB & Zentraler Zugangsknoten auf die Daten. Hält Referenzen auf die Artisten, Songs und Atlasse. \\
...
Eine weitere Klasse, die weiterhin guten Dienst leistet, ist beispielsweise die Klasse \code{CylinderRaycaster}. Dessen Aufgabe war ursprünglich, die grosse Anzahl Bilder handhabbar zu machen, weil einzelnes Raycasting zu viel Zeit beanspruchen würde. Da Performance immer ein Problem ist, erweist sich diese als nützlich.
