...
\begin{enumerate}
	\item einer für das Event-System von Unity
	\item einer für die gesamte Welt (näher erläutert in Kapitel \ref{subsec:performance})
	\item einer für die korreke Positionierung der Kamera (ebenfalls erläutert in Kapitel \ref{subsec:performance})
	\item einer für die Handhabung der Partikel der Hände
\end{enumerate}
